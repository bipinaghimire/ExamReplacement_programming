...
def show_records():
    ...
    def delete():
        """This function 'delete' is made to make us enable to delete a record"""
        conn = sqlite3.connect('School_Management.db')
        c = conn.cursor()
    ...
    def edit():
        """This is a function so as to edit a certain record"""
        conn = sqlite3.connect('School_Management.db')
        c = conn.cursor()
    ...
    def update():
        "This is new frame for updating a record"
        ...
        save_button = Button(Update_frame, text='SAVE', font=('Cambria 15 italic', 13, 'bold'), width=15, bd=5, command = edit)
