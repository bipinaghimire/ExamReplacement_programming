...
def submit():
    ...
    #conditions for proper sumissions of data
    if id.get() == "":
...
def show_records():
    ...
    def show():
        ...
        """This is function to show entered data into our treeview table"""
        if search_std.get() == "ID":
            if search_std.get() == "" or search_entry.get() == "":
                messagebox.showerror("Error", "Both fields are required")
                show_records()
            else:
                conn = sqlite3.connect('School_Management.db')
                c = conn.cursor()
                c.execute("SELECT *, student_id FROM addresses WHERE student_id ="+search_entry.get())
            ...
            if search_std.get() == "" or search_entry.get() == "":
                ...
                conn = sqlite3.connect('School_Management.db')
                c = conn.cursor()
                c.execute("SELECT *, class FROM addresses WHERE class=" +search_entry.get())
